...
// Returns NULL on failure, i.e., if the DLL is NULL or if there is noting to pop from the list.
...
// Returns a NULL on failure, i.e., if the DLL is NULL or if there is noting to pop from the list.
// Assume no negative numbers in the list or the number zero.
